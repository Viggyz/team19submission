...
function AuthModal({ openAuthModal, handleAuthClose, setsnackbarState }) {
  ...
  return (
    <Modal open={openAuthModal} onClose={handleAuthClose}>
      <Box>
        <Paper
          style={{
            position: "absolute",
        ...
        >
          {isSignUp ? (
            <div className="signup-Modal">
              <Typography variant="h5" className="signup-label">
                SIGN UP{" "}
              </Typography>
              <TextField
                ...
                error={
                  !username_regex.test(signUpDetails.username) &&
                  errors.username
                }
                helperText={
                  !username_regex.test(signUpDetails.username) &&
              ...
              <TextField
                ...
                error={
                  !phone_regex.test(signUpDetails.contactNo) &&
                  errors.contactNo &&
                  true
                }
                helperText={
              ...
              <TextField
                ...
                helperText={
                  signUpDetails.password.length < 4 ? errors.password : ""
                }
              />
              <Button
                variant="outlined"
