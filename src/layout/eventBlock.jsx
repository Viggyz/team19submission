    ...
    >
      ...
      >
        <Typography variant="h5">
          {location ? location.name : "Nearby events"}
        </Typography>
        {location && (
          <Box>
            <Box
        ...
        <Box sx={{ height: "100%", overflow: "auto" }}>
          <List>
            {currentEvents && currentEvents.length ? (
                    ...
                    >
                      <Box>
                        ...
                        <Typography variant="caption">
                          {moment(event.start_time).fromNow()}
                        </Typography>
                      </Box>
                    </ListItemButton>
                  </ListItem>
              ...
              >
                Click "Add Event" to create a new event here!
              </Typography>
            ) : (
              <Typography
                variant="body2"
              ...
              >
                Click on a location to start adding events
              </Typography>
            )}
          </List>
        </Box>
